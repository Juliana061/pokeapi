...
function Aleatorios() {
    ...
    for (let i = 0; i < 4; i++) {
        // Generar un número aleatorio dentro del rango de pokémon disponibles
    ...
    // Mostrar los nuevos pokémon generados
...
function Capturados() {
    ...
    // Crear álbum de pokémon capturados
